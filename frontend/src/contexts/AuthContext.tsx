...
interface AuthContextType {
  ...
  register: (data: { username: string; password: string; realName?: string; groupIds: string[] }) => Promise<void>
  logout: () => Promise<void>
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const register = async (data: { username: string; password: string; realName?: string; groupIds: string[] }) => {
