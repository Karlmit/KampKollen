...
export function Modal({ open, onClose, title, children, footer }: ModalProps) {
  ...
  // Backdrop and sheet are siblings in the portal so each animates independently.
  // If they were parent/child, animating opacity on the backdrop would hide the
  // still-sliding sheet before it finishes moving.
  return createPortal(
    <>
      <div
